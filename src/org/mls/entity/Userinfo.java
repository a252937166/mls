...
public class Userinfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public Userinfo(Usertypeinfo usertypeinfo, String uflogname,
			String ufpassword, String ufnum, Timestamp uflogdate) {
	...
	/** full constructor */
	public Userinfo(Usertypeinfo usertypeinfo, String uflogname,
			String ufpassword, Integer ufsex, Date ufbirthday, String ufnum,
			String ufqq, String ufemail, Timestamp uflogdate, Integer uflocked,
			Set orderinfos, Set goodscomments, Set goodscollections) {
		this.usertypeinfo = usertypeinfo;
		this.uflogname = uflogname;
		this.ufpassword = ufpassword;
		this.ufsex = ufsex;
